...
function show_edit_form(data, read_only = false) {
    ...
    DOM.add_form({
        ...
        fields: {
            ...
            rack_u: {type: "string", label: "Rack U", value: data.rack_u},
        ...
        REQUESTS.post(`/api/db/asset/${data.id}`, {fields: {
            ...
            rack_u: parseInt(form_result.rack_u),
    ...
    new_button.addEventListener("click", () => {
        DOM.add_form({
            ...
            fields: {
                ...
                rack: {type: "select", label: "Rack", options: options.rack.data, value: ""},
                rack_u: {type: "string", label: "Rack U", value: "0"},
